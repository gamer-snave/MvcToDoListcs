...
namespace MvcToDoList.Controllers
{
    public class ToDoListController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Task,Description,Status,Priority,Assignee,Comments,Created,CompleteBy")] ToDoList toDoList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Task,Description,Status,Priority,Assignee,Comments,Created,CompleteBy")] ToDoList toDoList)
        {
            if (id != toDoList.Id)
            {
                return NotFound();
